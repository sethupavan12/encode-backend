...
class AiAgent:
    ...
    def generate_comment(self, visual_description,audio_description)->str:
        """
        ...
        :param audio_description: str (The audio description of the live feed)
        :return: str (The comment generated by the agent)
        """
        output = self.llm_chain.invoke(visual_description, audio_description)
